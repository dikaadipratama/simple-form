...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2021 at 03:44 PM
...
--
-- Database: `pendaftaran_mhs_baru_fikom`
--

-- --------------------------------------------------------

--
-- Table structure for table `data_mhs_baru`
--

CREATE TABLE `data_mhs_baru` (
  `no_daftar` int(11) NOT NULL,
  `nama` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nik` char(16) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tempat_lahir` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tgl_lahir` date NOT NULL,
  `jk` int(11) NOT NULL,
  `kewarganegaraan` char(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `agama` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nama_ibu` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `no_telp` char(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `alamat` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `kode_pos` char(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `provinsi` int(11) NOT NULL,
  `kabupaten` int(11) NOT NULL,
  `kecamatan` int(11) NOT NULL,
  `pendidikan` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sekolah` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nilai_rapot` float NOT NULL,
  `progdi1` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `progdi2` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `data_mhs_baru`
--

INSERT INTO `data_mhs_baru` (`no_daftar`, `nama`, `nik`, `tempat_lahir`, `tgl_lahir`, `jk`, `kewarganegaraan`, `agama`, `nama_ibu`, `email`, `no_telp`, `alamat`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `pendidikan`, `sekolah`, `nilai_rapot`, `progdi1`, `progdi2`) VALUES
(1, 'Dika Adi Pratama', '1110021101912', 'Sukoharjo', '2001-11-02', 1, 'WNI', 'Islam', 'Suparmi', 'dikaadi482@gmail.com', '082233777084', 'Sanggrahan', '57556', 33, 3311, 331110, 'SMK', 'SMK N 3 SUKOHARJO', 33.5, 'S1 - Teknik Informatika', 'S1 - Sistem Informasi');
...
--
-- Indexes for table `data_mhs_baru`
--
ALTER TABLE `data_mhs_baru`
...
--
-- AUTO_INCREMENT for table `data_mhs_baru`
--
ALTER TABLE `data_mhs_baru`
